...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/1/1-2.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{figures/1/1-3.pdf}
...
\begin{example}\label{exa:point}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/1/1-4.pdf}
  \end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{figures/1/1-5.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{figures/1/1-6.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/1/1-7.pdf}
...
\begin{example}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/1/1-8.pdf}
  \end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{figures/1/1-9.pdf}
  \caption*{The intersection of two different lines is a point.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{figures/1/1-10.pdf}
  ...
  \begin{solution}
    \begin{enumerate}
      \item The line \(\ell\) is in the plane \(\symbf{M}\).
        ...
        \includegraphics[width=0.4\textwidth]{figures/1/1-11.pdf}

      \item The line \(\ell\) does not intersect the plane \(\symbf{M}\).

        \includegraphics[width=0.4\textwidth]{figures/1/1-12.pdf}

      \item The line \(\ell\) intersects the plane \(\symbf{M}\) at a point.

        \includegraphics[width=0.4\textwidth]{figures/1/1-13.pdf}
    \end{enumerate}
  \end{solution}
\end{example}
...
\begin{example}
  ...
  \begin{solution}
    ...
    \begin{figure}[H]
      \includegraphics[width=0.5\textwidth]{figures/1/1-14.pdf}
    \end{figure}
  \end{solution}
\end{example}
